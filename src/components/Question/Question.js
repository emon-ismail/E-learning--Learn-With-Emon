  ...
  return (
    ...
    <div>
      <div className='p-5 border m-5 bg-info'>
            <h4>Ques : {questionn.question}       <button onClick={trueAns}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
